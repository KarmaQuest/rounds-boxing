 ...
 * - upcoming : combats à venir (The Odds API → programmation officielle
 *   vérifiée des shards fights-upcoming/, zéro mock)
 * - recent   : résultats récents (shards officiels → TheSportsDB → mock)
